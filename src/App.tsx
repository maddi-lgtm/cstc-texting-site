...
export default function App() {
  ...
  async function executeSendCampaign() {
    ...
    while (hasMore) {
      console.log("send-campaign batch starting", {
        batchNumber,
        batchSize,
        batchOffset,
      });
      ...
      totalSuccess += successThisBatch;
      totalFailure += failureThisBatch;
      ...
      if (sentThisBatch === 0 && hasMore) {
        console.error("send-campaign stopped because a batch returned 0 sent while has_more was true", {
          data,
          batchOffset,
          totalEligible,
        });
        ...
        showNotice(
          `Send stopped after ${totalSent} message(s). Batch returned 0 messages while more were expected.`
        );
